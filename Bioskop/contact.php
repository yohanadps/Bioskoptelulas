        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="pilih_film.php">Pendaftaran</a>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    ...
                    <p>Email:
                        <strong><a href="secretcodeot5@gmail.com">BIOSKOPTELULAS@gmail.com></strong>
                    </p>
                    <p>Address:
                        <strong>Gedung Teknik Informatika 
                            <br>Kampus ITS Sukolilo, Surabaya, 60111 </strong>
                    </p>
                </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">KRITIK DAN SARAN
                    </h2>
                    <hr>
                    <form role="form">
                        <div class="row">
